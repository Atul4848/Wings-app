...
import { PolicyScheduleModel, SettingsProfileModel } from '../../Shared';
import { ModalStore } from '@uvgo-shared/modal-keeper';
import { CustomAgGridReact } from '@wings-shared/custom-ag-grid';
import sinon from 'sinon';
import ScheduleGrid from '../Component/ScheduleGrid/SchedulerGrid';
import { CollapsibleWithButton } from '@wings-shared/layout';
import { GRID_ACTIONS } from '@wings-shared/core';

describe('Performance Schedule grid', () => {
  let wrapper: any;
  ...
  const props = {
    ...
    isEditable: true,
    title : '',
    rowData: [new PolicyScheduleModel()],
  ...
  beforeEach(() => {
    wrapper = shallow(<ScheduleGrid {...props} />);
