...
import AerodromeRefCode from '../Components/AerodromeRefCode/AerodromeRefCode';
import { SearchHeaderV3 } from '@wings-shared/form-controls';

describe('AerodromeRefCode module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<AerodromeRefCode {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertAerodromeRefCode');
  ...
  it('onDropDownChange should set hasError value based on changes', () => {
    ...
    parentComp.onDropDownChange({ colDef: { field: 'Code' } } as any, '');
  });
