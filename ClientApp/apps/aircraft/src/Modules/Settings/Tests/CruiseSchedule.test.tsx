...
import { PerformanceStoreMock, SpeedScheduleSettingsStoreMock } from '../../Shared';
import { SearchHeaderV3 } from '@wings-shared/form-controls';
import { CruiseSchedule } from '../Components';

describe('Cruise Schedule Settings', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<CruiseSchedule {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.speedScheduleSettingsStore, 'upsertCruiseSchedule');
