...
import { NoiseChapterConfiguration } from '../Components';

describe('Noise Chapter Configuration Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<NoiseChapterConfiguration {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertNoiseChapterConfiguration');
