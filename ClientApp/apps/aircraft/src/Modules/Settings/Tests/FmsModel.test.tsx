...
import { FmsModelComponent } from '../Components';

describe('FMS Model Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<FmsModelComponent {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.avionicsSettingsStore, 'upsertFmsModel');
