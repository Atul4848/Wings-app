...
import { FuelReservePolicy } from '../Components';

describe('Fuel Reserve Policy Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<FuelReservePolicy {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertFuelReservePolicy');
