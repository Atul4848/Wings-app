...
import AesModelComponent from '../Components/AesModel/AesModel';
import { SearchHeaderV3 } from '@wings-shared/form-controls';

describe('AesModelComponent module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<AesModelComponent {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.avionicsSettingsStore, 'upsertAesModel');
  ...
  it('onDropDownChange should set hasError value based on changes', () => {
    ...
    parentComp.onDropDownChange({ colDef: { field: 'aesManufacturer' } } as any, '');
  });
