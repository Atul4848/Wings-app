...
describe('EngineType module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<EngineType {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertEngineType');
  ...
  it('onDropDownChange should set hasError value based on changes', () => {
    ...
    parentComp.onDropDownChange({ colDef: { field: 'engineTypeSeries' } } as any, '');
  });
