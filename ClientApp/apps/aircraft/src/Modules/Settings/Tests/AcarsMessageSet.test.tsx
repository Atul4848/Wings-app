...
import AcarsMessageSet from '../Components/AcarsMessageSet/AcarsMessageSet';
import { SearchHeaderV3 } from '@wings-shared/form-controls';

describe('AcarsMessageSet module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<AcarsMessageSet {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.avionicsSettingsStore, 'upsertAscarMessageSet');
  ...
  it('onDropDownChange should set hasError value based on changes', () => {
    ...
    parentComp.onDropDownChange({ colDef: { field: 'acarsSoftwareVersion' } } as any, '');
  });
