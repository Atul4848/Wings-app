...
import AcarsModelComponent from '../Components/AcarsModel/AcarsModel';
import { SearchHeaderV3 } from '@wings-shared/form-controls';

describe('AcarsModelComponent module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<AcarsModelComponent {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.avionicsSettingsStore, 'upsertAcarsModel');
  ...
  it('onDropDownChange should set hasError value based on changes', () => {
    ...
    parentComp.onDropDownChange({ colDef: { field: 'acarsManufacturer' } } as any, '');
  });
