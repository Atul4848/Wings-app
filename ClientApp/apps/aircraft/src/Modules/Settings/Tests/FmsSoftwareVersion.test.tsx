...
import { FmsSoftwareVersion } from '../Components';

describe('FMS Software Version Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<FmsSoftwareVersion {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.avionicsSettingsStore, 'upsertFmsSoftwareVersion');
