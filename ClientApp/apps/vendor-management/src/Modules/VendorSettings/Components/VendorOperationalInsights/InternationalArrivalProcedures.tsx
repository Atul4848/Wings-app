...
const InternationalArrivalProcedures: FC<Props> = ({ settingsStore }) => {
  ...
  return (
    <SettingCore
      ...
      rightContentActionText="Add International Arrivale Procedures"
...
export default inject('settingsStore')(observer(InternationalArrivalProcedures));
