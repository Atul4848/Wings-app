...
import { PassportNationality } from '../Components';
import { CustomAgGridReact } from '@wings-shared/custom-ag-grid';
import { SearchHeaderV3 } from '@wings-shared/form-controls';
import { PrimaryButton } from '@uvgo-shared/buttons';

describe('Passport Nationality Component', () => {
  let wrapper: any;
  ...
  beforeEach(() => {
    wrapper = shallow(<PassportNationality {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertPassportNationality');
