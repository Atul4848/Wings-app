...
import { ConditionType } from '../Components';
...
describe('Condition Type Setting Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<ConditionType {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.airportSettingsStore, 'upsertConditionType');
  ...
  it('should not render Add Conditional Type button if edit permission is not provided', () => {
    wrapper
      .find(SearchHeaderV3)
      .props()
      .rightContent();
