...
import { ServicesModel, ServicesStoreMock } from '../../Shared';
import { expect } from 'chai';
import sinon from 'sinon';
import { ModalStore } from '@uvgo-shared/modal-keeper';
import Services, { PureServices } from '../Services';
...
describe('Services', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<PureServices {...props} />).dive();
    instance = wrapper.instance();
    instance.gridApi = new GridApiMock({ data: new ServicesModel() });
  });
