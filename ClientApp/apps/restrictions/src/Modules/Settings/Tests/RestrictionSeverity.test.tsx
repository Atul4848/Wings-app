...
import { RestrictionSeverity } from '../Components';
import { of } from 'rxjs';
...
describe('RestrictionSeverity Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<RestrictionSeverity {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.aircraftOperatorSettingsStore, 'upsertRestrictionSeverity');
