...
import { LeadTimeIndicator } from '../Components';
...
describe('LeadTime Indicator Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<LeadTimeIndicator {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertLeadTimeIndicator');
