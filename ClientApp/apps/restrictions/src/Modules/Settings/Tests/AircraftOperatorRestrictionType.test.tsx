...
import { AircraftOperatorRestrictionType } from '../Components';
import { of } from 'rxjs';

import { SearchHeaderV3 } from '@wings-shared/form-controls';
import { GRID_ACTIONS, SettingsTypeModel } from '@wings-shared/core';
import { AircraftOperatorSettingsStoreMock } from '../../Shared';
import { SettingsModuleSecurity } from '@wings-shared/security';
import { PrimaryButton } from '@uvgo-shared/buttons';

describe('Aircraft Operator RestrictionType Module', () => {
  ...
  const props = {
    ...
    upsertAircraftOperatorRestrictionType: sinon.fake.returns(of(new SettingsTypeModel())),
  };

  beforeEach(() => {
    wrapper = shallow(<AircraftOperatorRestrictionType {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.aircraftOperatorSettingsStore, 'upsertAircraftOperatorRestrictionType');
