...
describe('UWAAllowableAction', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<UWAAllowableAction {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertUWAAllowableAction');
