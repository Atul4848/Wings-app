...
import { FlightAllowed } from '../Components';
...
describe('Flight Allowed Module', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<FlightAllowed {...props} />).dive();
  ...
  it('should call upsert function on save button click', () => {
    const mock = sinon.spy(props.settingsStore, 'upsertFlightAllowed');
