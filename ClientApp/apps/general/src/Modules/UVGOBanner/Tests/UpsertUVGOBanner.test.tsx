...
import UpsertUVGOBanner from '../Components/UpsertUVGOBanner/UpsertUVGOBanner';
import { UVGOBannerModel, UVGOBannerServicesModel, UVGOBannerStoreMock, UVGOBannerTypeModel } from '../../Shared';

describe('Upsert UVGOBanner Dialog', () => {
  ...
  const props = {
    ...
    upsertUVGOBanner: sinon.fake(),
    viewMode: VIEW_MODE.EDIT,
    message: 'abc',
    uvgoBanner: new UVGOBannerModel({
  ...
  const renderView = props => {
    wrapper = shallow(<UpsertUVGOBanner {...props} />)
      .dive()
      .shallow();
  ...
  it('save button should call upsertUVGOBanner on props', () => {
    dialogContent.find(PrimaryButton).simulate('click');
    expect(props.upsertUVGOBanner.calledOnce).to.true;
  });
  ...
  it('onValueChange should update form value', () => {
    ...
    instance.getField('message').set = mockFormUpdate;
    instance.onValueChange('test', 'message');
